...
function likeCounter () {    
    ...
    if(likeListItem) {
        ...
        const counterObj = counterLikes.find(item => item.name === currentCount.toString);
        ...
        newLikeList.textContent = `${currentCount} has been liked 1 time`;
        likesList.appendChild(newLikeList);
    }
    // const likeItem = document.createElement('li');
    // console.log(counterLikes[counter.textContent]);
    // counterLikes[counter.textContent]++;
    // console.log(counterLikes[counter.textContent]);
